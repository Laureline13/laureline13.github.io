...
function ouvrirPagePaiement() {
    ...
    if (!nom || !prenom || !adresse) {
        alert("Veuillez renseigner votre nom, prénom et adresse.");
        return;
    }
    ...
    localStorage.setItem("recapCommande", JSON.stringify({ nom, prenom, adresse, pharmacie: pharmacieChoisie, commande, total }));
